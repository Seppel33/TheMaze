...
public class MenuWindow extends JFrame {
    ...
    private File folderInput1 = new File("res\\menuImage1.png");
    private File folderInput2 = new File("res\\menuImage2.png");
    ...
    public MenuWindow() {
        ...
        this.setLayout(null);
        try {
            if(new Dimension(Toolkit.getDefaultToolkit().getScreenSize()).height>1080&&new Dimension(Toolkit.getDefaultToolkit().getScreenSize()).width==1920){
                folderImageBackdrop = ImageIO.read(folderInput2);
            }else {
                folderImageBackdrop = ImageIO.read(folderInput1);
            }
        } catch (Exception e) {
    ...
    private void startPlaySelectPanel() {
        ...
        loadLabyrinth.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                fileChooser.setCurrentDirectory(new File("Speicherstände\\"));
